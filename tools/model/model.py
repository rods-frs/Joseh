...
def init_models(CAT_MODEL_PATH='tools/model/joseh_cat_model_v4', NER_MODEL_PATH='tools/model/joseh_ner_model_v2'):
...
def detect_intent(text, threshold=0.5):
    ...
    try:
        ...
        detected_commands = []
        special_clauses = []
        special_commands = ["play_music", "open_program", "install_program"]
